...
const NotFoundPage = () => {
  ...
  return (
    <div className="not-found-page relative h-screen w-screen overflow-hidden">
      {/* Background */}
      <div
      ...
      <svg
        ...
        y="0px"
        viewBox="0 0 700 250"
        className="absolute w-[600px] max-w-full top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"
      >
        <g>
          <path
            id="id3_2"
      ...
      {/* SVG tersembunyi untuk filter definisi */}
      ...
      {/* Teks "Page Not Found" dengan efek neon khusus */}
      <h2 className="absolute top-1/2 left-1/2 mt-36 transform -translate-x-1/2 -translate-y-1/2 text-2xl uppercase font-light not-found-text">
